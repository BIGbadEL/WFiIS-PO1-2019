...
class Car {
    ...
    public:
        ...
        Car(std::string name, std::string fule, int capacity, int power, std::string color = _color_default, int wheels = 4)
            : _name(name), _color(color), _engine(fule, capacity, power), _wheels(wheels){
