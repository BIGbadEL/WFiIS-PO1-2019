...
class Car {
    ...
    public:
        ...
        /**
         * @brief   funkcja zwracajaca nowy punkt koordynacyjny
         * 
         * @return  Coordinate  nowy punkt koordynacyjny  
         */
        Coordinate UpdateLocation(float x, float y){
            _gps.updateLoc(x, y);
            return Coordinate(x, y);
        }

        /**
         * @brief               funkcja zwracajaca lokacje GPS
         * @return std::string  lokacja GPS
         */
